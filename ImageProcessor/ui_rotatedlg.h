...
public:
    ...
    {
        RotateDlg->setWindowTitle(QApplication::translate("RotateDlg", "Dialog", Q_NULLPTR));
        lineEdit->setText(QApplication::translate("RotateDlg", "0.5", Q_NULLPTR));
        lineEdit_4->setText(QApplication::translate("RotateDlg", "0.866", Q_NULLPTR));
        lineEdit_2->setText(QApplication::translate("RotateDlg", "-0.866", Q_NULLPTR));
        lineEdit_5->setText(QApplication::translate("RotateDlg", "0.5", Q_NULLPTR));
        lineEdit_3->setText(QApplication::translate("RotateDlg", "0", Q_NULLPTR));
        lineEdit_7->setText(QApplication::translate("RotateDlg", "0", Q_NULLPTR));
        lineEdit_8->setText(QApplication::translate("RotateDlg", "0", Q_NULLPTR));
        lineEdit_6->setText(QApplication::translate("RotateDlg", "0", Q_NULLPTR));
        lineEdit_9->setText(QApplication::translate("RotateDlg", "1", Q_NULLPTR));
    } // retranslateUi
