...
public:
    ...
    {
        LowPassFilterDlg->setWindowTitle(QApplication::translate("LowPassFilterDlg", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("LowPassFilterDlg", "  LowPassFilterThreshold : ", Q_NULLPTR));
    } // retranslateUi
