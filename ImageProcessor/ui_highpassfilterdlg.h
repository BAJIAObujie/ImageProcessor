...
public:
    ...
    {
        HighPassFilterDlg->setWindowTitle(QApplication::translate("HighPassFilterDlg", "Dialog", Q_NULLPTR));
        label->setText(QApplication::translate("HighPassFilterDlg", "  HighPassFilterThreshold : ", Q_NULLPTR));
    } // retranslateUi
